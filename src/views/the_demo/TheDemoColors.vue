<template>
  <div>
    ...
    <m-row class="text-hint">
      <m-cube style="background:var(--primary)">
        primary
      </m-cube>
      <m-cube style="background:var(--secondary);color:var(--text)">
        secondary
      </m-cube>
      <m-cube style="background:var(--success)">
        success
      </m-cube>
      <m-cube style="background:var(--warning)">
        warning
      </m-cube>
      <m-cube style="background:var(--info)">
        info
      </m-cube>
      <m-cube style="background:var(--error)">
        error
      </m-cube>
    </m-row>
...
<script>
import mCube from "../../common/Cube.vue";
export default {
  name: "the-demo-style",
  components: { mCube }
};
