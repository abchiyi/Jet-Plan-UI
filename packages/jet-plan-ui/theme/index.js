...
const theme = reactive({
    ...
    darkMode: false,
    autoDarkMode: false,
    watchTheneChange (_this) {
        _this.$watch(() => theme.darkMode, (v) => {
            use(theme.themeList, theme.autoDarkMode, v)
        })
        _this.$watch(() => theme.autoDarkMode, (v) => {
            use(theme.themeList, v, theme.darkMode)
        })
        _this.$watch(() => theme.themeList, (v) => {
